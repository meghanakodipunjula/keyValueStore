...
public class Constants {
    public static final String defaultDataStoreLoc = "/Users/meghanakodipunzula/Documents/proj";
    ...
    public static final String FAILURE_VALUE_LENGTH_EXCEEDED = "Value length exceeded the limit(16KB)";
